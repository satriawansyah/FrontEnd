...
const PesananDetailAdminPage = () => {
  const { id } = useParams();
  const [loading, setLoading] = useState(true);
  // const [img, setImg] = useState("");
  // const [produkGambar, setProdukGambar] = useState({});
  ...
  // useEffect(() => {
  //   if (pesanan.length > 0) {
  //     const pesananItems = pesanan.map((pesananItem) => pesananItem.produk.gambar);
          ...
          <div className="content">
            <div className="content-inner">
              <div className="content-header">
                ...
                <div>
                  <Link to="/admin/pesanan" style={{ textDecoration: "none" }}>
...
export default PesananDetailAdminPage;
